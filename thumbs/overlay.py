...
# Draw a small overlay listing class probabilities for the current frame.
def draw_probability_panel(
    ...
    *,
    ...
    # Skip drawing when the caller did not provide class labels.
    ...
    # Draw one labeled bar per class to visualize probabilities.
...
# Display the predicted label/confidence plus the probability panel.
def overlay_prediction(
    ...
    *,
    ...
    # Highlight low-confidence results differently for visibility.
